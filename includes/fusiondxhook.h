...
public:
	static inline void Init()
	{
		...
		//DllCallbackHandler::RegisterCallback(L"d3d8.dll", []() { CloseHandle(CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)HookD3D8, NULL, 0, NULL)); });
		//DllCallbackHandler::RegisterCallback(L"d3d9.dll", []() { CloseHandle(CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)HookD3D9, NULL, 0, NULL)); });
		//DllCallbackHandler::RegisterCallback(L"d3d10.dll", []() { CloseHandle(CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)HookD3D10, NULL, 0, NULL)); });
		//DllCallbackHandler::RegisterCallback(L"d3d10_1.dll", []() { CloseHandle(CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)HookD3D10_1, NULL, 0, NULL)); });
		//DllCallbackHandler::RegisterCallback(L"d3d11.dll", []() { CloseHandle(CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)HookD3D11, NULL, 0, NULL)); });
		//DllCallbackHandler::RegisterCallback(L"d3d12.dll", []() { CloseHandle(CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)HookD3D12, NULL, 0, NULL)); });
