...
#define D3D8_MAKEFOURCC(ch0, ch1, ch2, ch3)                             \
...
typedef enum _D3DFORMAT_D3D8
{
  ...
  D3D8_D3DFMT_UYVY = D3D8_MAKEFOURCC('U', 'Y', 'V', 'Y'),
  D3D8_D3DFMT_YUY2 = D3D8_MAKEFOURCC('Y', 'U', 'Y', '2'),
  D3D8_D3DFMT_DXT1 = D3D8_MAKEFOURCC('D', 'X', 'T', '1'),
  D3D8_D3DFMT_DXT2 = D3D8_MAKEFOURCC('D', 'X', 'T', '2'),
  D3D8_D3DFMT_DXT3 = D3D8_MAKEFOURCC('D', 'X', 'T', '3'),
  D3D8_D3DFMT_DXT4 = D3D8_MAKEFOURCC('D', 'X', 'T', '4'),
  D3D8_D3DFMT_DXT5 = D3D8_MAKEFOURCC('D', 'X', 'T', '5'),
